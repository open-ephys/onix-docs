...
latex_documents = [
    (main_doc, 'onix-docs.tex', 'ONIX Documentation',
     'Open Ephys', 'manual'),
]
...
man_pages = [
    (main_doc, 'onix-docs', 'ONIX Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (main_doc, 'ONIX Documentation', 'ONIX Documentation',
     author, 'ONIX Documentation', 'Next-generation electrophysiology data acquisition',
     'Miscellaneous'),
]
