...
latex_documents = [
    (master_doc, 'open-ephs.tex', 'Open Ephys 2.0 Documentation',
     'Open Ephys', 'manual'),
]
...
man_pages = [
    (master_doc, 'open-ephys-2', 'Open Ephys 2.0 Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Open Ephys 2.0', 'Open Ephys 2.0 Documentation',
     author, 'Open Ephys 2.0', 'One line description of project.',
     'Miscellaneous'),
]
