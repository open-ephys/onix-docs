...
#. Download the :download:`OpenEphysTestDriver.cer
   <../_static/drivers/OpenEphysTestDriver.cer>` testing certificate and double
   click it.
...
#. Download the :download:`riffa driver <../_static/drivers/riffa.zip>` and unzip the archive.
