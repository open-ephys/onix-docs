...
Description
*******************************************
The **BNO055** ONIX device is a 9-axis intertial measurement unit (IMU) that provides
...
This device implemtation has hardcoded all of the configuration required to
...
*******************************************
This device does not permit register access. All requests will NAK.
